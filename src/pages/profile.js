...
function urlB64ToUint8Array(base64String) {
    ...
    const outputArary = new Uint8Array(rawData.length);

    for (let i = 0; i < rawData.length; ++i) {
        outputArary[i] = rawData.charCodeAt(i);
    }
    return outputArary;
}

async function subscribe() {
    const key = "BM0kQcVL1mtZNljRQo-hVIzCpGNb5NHFUwJ6gDIDtGb5YDxXERqxQyF9XigcdJrU4xxNX85uKfp5ynCNkdkNoBc"
